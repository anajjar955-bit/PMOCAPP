    ...
    <SafeAreaView style={styles.container}>
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <Text style={styles.subtitle}>سجل الآن للبدء في دورة PMI-PMO CP</Text>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <TextInput testID="register-name-input" style={styles.input} value={name} onChangeText={setName} placeholder="أدخل اسمك الكامل" placeholderTextColor="#94A3B8" textAlign="right" />
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <TextInput testID="register-email-input" style={styles.input} value={email} onChangeText={setEmail} placeholder="example@email.com" keyboardType="email-address" autoCapitalize="none" placeholderTextColor="#94A3B8" textAlign="right" />
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.inputWrapper}>
              <TextInput testID="register-password-input" style={styles.input} value={password} onChangeText={setPassword} placeholder="6 أحرف على الأقل" secureTextEntry placeholderTextColor="#94A3B8" textAlign="right" />
          ...
          <TouchableOpacity testID="go-to-login" onPress={() => router.push('/login')} style={styles.switchBtn}>
            <Text style={styles.switchText}>لديك حساب بالفعل؟ <Text style={styles.switchLink}>سجل دخول</Text></Text>
          </TouchableOpacity>
        </ScrollView>
